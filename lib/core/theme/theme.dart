...
class AppTheme {
  ...
  static final inputDecorationThemeData = InputDecorationTheme(
    ...
    focusedErrorBorder: _border().copyWith(borderSide: const BorderSide(color: AppPallete.errorColor, width: 3)),
  ...
  static final ThemeData darkThemeMode = ThemeData.dark().copyWith(
    ...
    chipTheme: const ChipThemeData(color: WidgetStatePropertyAll(AppPallete.backgroundColor)),
    dropdownMenuTheme: DropdownMenuThemeData(
      inputDecorationTheme: inputDecorationThemeData.copyWith(contentPadding: const EdgeInsets.all(6)),
    ),
